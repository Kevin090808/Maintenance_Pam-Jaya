...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="inspection-list">
            <li><a href="view_valve_tuneup.php"><i class="fas fa-eye"></i>Lihat Data</a></li>
            <li><a href="input_valve_tuneup.php"><i class="fas fa-plus-circle"></i>Tambah Data</a></li>
    ...
    <div class="main-content" id="mainContent">
        ...
        <h1>MECHANICAL VALVE TUNE UP</h1>
