...
if (!empty($selected_date)) {
    ...
    if ($result_date->num_rows > 0) {
        ...
        // Verify if there's data in preventif_thermograph for this date
        $verify_sql = "SELECT COUNT(*) as count FROM preventif_thermograph WHERE id_date = ?";
...
$stats_sql = "SELECT 
                ...
                AVG(temperatur) as avg_temp,
                SUM(CASE WHEN temperatur = 'Ada' THEN 1 ELSE 0 END) as units_with_freon
            FROM preventif_thermograph";
...
if (!empty($id_date) && $has_data) {
    ...
    $sql_motor = "SELECT * FROM preventif_thermograph WHERE id_date = ?";
    ...
    $sql_motor = "SELECT * FROM preventif_thermograph ORDER BY id_date DESC LIMIT 20";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <a href="preventif_thermograph.php" class="btn btn-secondary me-2">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="10%">Tanggal Pengecekan</th>
                                <th width="15%">Lokasi</th>
                                <th width="15%">No Urut Thermograph</th>
                                <th width="10%">Nama Equipment</th>
                                <th width="10%">Temperatur (Deg.c)</th>
                        ...
                        <tbody>
                            ...
                            if (isset($result_motor) && $result_motor->num_rows > 0) {
                                ...
                                while ($row = $result_motor->fetch_assoc()) {
                                    ...
                                    echo "<td>" . htmlspecialchars($row['tanggal_pengecekan']) . "</td>";
                                    echo "<td>" . htmlspecialchars($row['lokasi']) . "</td>";
                                    echo "<td>" . htmlspecialchars($row['no_urut']) . "</td>";
                                    echo "<td>" . htmlspecialchars(string: $row['nama_equipment']) . "</td>";
                                    echo "<td>" . htmlspecialchars(string: $row['temperatur']) . "  Deg°C</td>";
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="view_preventif.php" method="GET">
                        <div class="mb-3">
