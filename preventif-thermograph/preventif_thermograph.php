...
<head>
    ...
    <title>PREVENTIF THERMOGAPH</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="inspection-list">
            <li><a href="view_preventif.php"><i class="fas fa-eye"></i>Lihat Data</a></li>
            <li><a href="input_preventif.php"><i class="fas fa-plus-circle"></i>Tambah Data</a></li>
