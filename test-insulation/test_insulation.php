...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="inspection-list">
            <li><a href="view_insulation.php"><i class="fas fa-eye"></i>Lihat Data</a></li>
            <li><a href="input_insulation.php"><i class="fas fa-plus-circle"></i>Tambah Data</a></li>
    ...
    <div class="main-content" id="mainContent">
        ...
        <h1>TEST INSULATION</h1>

        <div class="table-container">
            <table class="table">
                <thead>
                    <tr>
                        <th rowspan="2" class="text-left">Equipment</th>
                        <th rowspan="2" class="text-left">measurement</th>
                        <th rowspan="2" class="text-left">inject volt</th>
                        <th rowspan="2" class="text-left">Result insulation</th>
                        <th colspan="2">index</th>
                        <th rowspan="2" class="text-left">condition</th>
                    </tr>
                    <tr>
                        <th class="hasil-col">DAR</th>
                        <th class="hasil-col">PI</th>
                    </tr>
                </thead>
                <tbody>
                     <tr>
                        <td class="text-center" rowspan="7" style="vertical-align: middle;">
                            <br />
                        </td>
                        </tr>
                        <tr>
            ...
            <h1>TEST RESISTENSI GULUNGAN MOTOR</h1>
            ...
            <table class="table">
                <thead>
                    <tbody>
                    <tr>
                        <th colspan="1" class="text-left">Equipment</th>
                        <th rowspan="2" class="text-left">measurement</th>
                        <th rowspan="2" class="text-left">Reasult</th>
                        <th rowspan="2" class="text-left">COndition</th>
                    </tr>
                    <tr>
