...
if (!empty($selected_date)) {
    ...
    if ($result_date->num_rows > 0) {
        ...
        // Verify if there's data in valve_tuneup    for this date
        $verify_sql = "SELECT COUNT(*) as count FROM valve_tuneup    WHERE id_date = ?";
...
$stats_sql = "SELECT 
                ...
                SUM(CASE WHEN status = 'Ada' THEN 1 ELSE 0 END) as units_with_freon
            FROM valve_tuneup   ";
...
if (!empty($id_date) && $has_data) {
    ...
    $sql_motor = "SELECT * FROM valve_tuneup     WHERE id_date = ?";
    ...
    $sql_motor = "SELECT * FROM valve_tuneup     ORDER BY id_date DESC LIMIT 20";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <a href="valve_tuneup.php" class="btn btn-secondary me-2">
        ...
        <div class="alert alert-info d-flex align-items-center justify-content-between">
            ...
            <a href="view_valve_tuneup.php" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="empty-state">
                    ...
                    <a href="view_valve_tuneup.php" class="btn btn-primary mt-3">Lihat Semua Data</a>
                </div>
                <?php elseif (!$has_data): ?>
                <div class="empty-state">
                    ...
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="15%">nama_part</th>
                                <th width="10%">penggantian Part</th>
                                <th width="10%">JUmlah Part</th>
                                <th width="10%">Detail Pekerjaan</th>
                        ...
                        <tbody>
                            ...
                            if (isset($result_motor) && $result_motor->num_rows > 0) {
                                ...
                                while ($row = $result_motor->fetch_assoc()) {
                                    ...
                                    echo "<td>" . htmlspecialchars(string: $row['penggantian_part']) . "</td>";
                                    echo "<td>" . htmlspecialchars(string: $row['jumlah_part']) . "</td>";
                                    echo "<td>" . htmlspecialchars(string: $row['detail_pekerjaan']) . "</td>";
                                    echo "<td>";
                                    if ($row['status'] == 'Ada') {
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="view_valve_tuneup.php" method="GET">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <?php if (!empty($selected_date)): ?>
                            <a href="view_valve_tuneup.php" class="btn btn-outline-secondary">Reset Filter</a>
                            <?php else: ?>
